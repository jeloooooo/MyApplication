...
public class DisplayContact extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bundle extras = getIntent().getExtras();
        {
            ...
            if (Value > 0) {
                ...
                String studescription = rs.getString(rs.getColumnIndex(DBHelper.CONTACTS_COLUMN_STUDESCRIPTION));
                ...
                description.setText((CharSequence) studescription);
    ...
    /*   mydb.addContact(name.getText().toString(),email.getText().toString(), street.getText().toString(), place.getText().toString(), phone.getText().toString());
        ...
        if (extras != null) {
            int Value = extras.getInt("id");
            if (Value > 0) {
                if (mydb.updateStudentContact(id_To_Update, name.getText().toString(), phone.getText().toString(), street.getText().toString(),email.getText().toString(), place.getText().toString(), description.getText().toString())) {
                ...
                if (mydb.addStudentContact(name.getText().toString(), phone.getText().toString(),street.getText().toString(), email.getText().toString(),  place.getText().toString(), description.getText().toString())) {
