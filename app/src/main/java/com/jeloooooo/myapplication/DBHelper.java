...
/**
 * Created by ap186046 on 3/17/2017.
 */
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String CONTACTS_COLUMN_STUDESCRIPTION = "description";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL(
                "create table mycontacts " +
                        "(id integer primary key autoincrement, name text,phone text,email text, street text,place text, description text)"
        );
    }
    ...
    public boolean addStudentContact(String contactname,String contactphone,String contactstreet,String contactemail, String contactplace, String contactdesc){
        /*,*/
        ...
        contantValues.put("description",contactdesc);
        db.insert("mycontacts", null, contantValues);
        db.close();
        return true;
    }

    public boolean updateStudentContact(Integer contactid,String contactname,String contactphone,String contactstreet,String contactemail, String contactplace, String contactdesc)
    {
        /*,String contactname,*/
        SQLiteDatabase db=this.getWritableDatabase();
        ContentValues contantValues = new ContentValues();
